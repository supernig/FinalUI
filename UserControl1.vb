...
Public Class UserControl1
    ...
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Using con As New MySqlConnection(myConnectionString)
            Using cmd As New MySql.Data.MySqlClient.MySqlCommand("SELECT items.id,items.name, COUNT(tagID) as maoni FROM items where categoryID=" & ComboBox1.SelectedIndex + 1, conn)
